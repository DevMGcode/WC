...
/** Texto introductorio editorial de la fase eliminatoria / cuadro (7 idiomas). */
export function knockoutIntroText(locale: string): string {
  const intro: Record<Lang, string> = {
    es: 'La fase eliminatoria del Mundial 2026 define al campeón a partido único: dieciseisavos, octavos de final, cuartos de final, semifinales, el partido por el tercer puesto y la gran final. Quien pierde queda eliminado; si un partido termina empatado tras la prórroga, se decide en la tanda de penales. En el cuadro de eliminatorias siguen la ruta de cada selección ronda por ronda —con las fechas, los cruces y los resultados— y pueden tocar cada partido para ver su marcador, goleadores y detalle.',
    en: 'The knockout stage of the 2026 World Cup decides the champion in single-elimination matches: round of 32, round of 16, quarter-finals, semi-finals, the third-place play-off and the grand final. The loser is out; if a match is tied after extra time, it is settled in a penalty shootout. In the bracket you can follow each team\'s path round by round — with dates, matchups and results — and tap any match to see its score, scorers and full detail.',
    fr: 'La phase à élimination directe de la Coupe du Monde 2026 désigne le champion par matchs à élimination directe : seizièmes, huitièmes de finale, quarts de finale, demi-finales, le match pour la troisième place et la grande finale. Le perdant est éliminé ; si un match est à égalité après prolongation, il se décide aux tirs au but. Dans le tableau, suivez le parcours de chaque sélection tour par tour — avec les dates, les affiches et les résultats — et touchez un match pour voir le score, les buteurs et le détail.',
    pt: 'A fase eliminatória da Copa do Mundo 2026 define o campeão em jogos de mata-mata: 16 avos, oitavas de final, quartas de final, semifinais, a disputa de terceiro lugar e a grande final. Quem perde está eliminado; se um jogo termina empatado após a prorrogação, é decidido nos pênaltis. No chaveamento você acompanha o caminho de cada seleção rodada a rodada — com datas, confrontos e resultados — e pode tocar em cada jogo para ver o placar, os artilheiros e os detalhes.',
    de: 'Die K.-o.-Runde der WM 2026 kürt den Weltmeister im K.-o.-System: Sechzehntel-, Achtel-, Viertel- und Halbfinale, das Spiel um Platz drei und das große Finale. Der Verlierer scheidet aus; steht es nach der Verlängerung unentschieden, entscheidet das Elfmeterschießen. Im Turnierbaum verfolgst du den Weg jeder Mannschaft Runde für Runde — mit Terminen, Paarungen und Ergebnissen — und kannst jedes Spiel antippen, um Ergebnis, Torschützen und Details zu sehen.',
    ru: 'Плей-офф Чемпионата мира 2026 определяет чемпиона в матчах на вылет: 1/16, 1/8 финала, четвертьфиналы, полуфиналы, матч за третье место и большой финал. Проигравший выбывает; если после дополнительного времени ничья, всё решает серия пенальти. В турнирной сетке можно проследить путь каждой сборной раунд за раундом — с датами, парами и результатами — и открыть любой матч, чтобы увидеть счёт, бомбардиров и подробности.',
    ar: 'يحدّد الدور الإقصائي في كأس العالم 2026 البطل عبر مباريات خروج المغلوب: دور الـ32، ثمن النهائي، ربع النهائي، نصف النهائي، مباراة تحديد المركز الثالث، والنهائي الكبير. الخاسر يخرج من البطولة؛ وإذا انتهت المباراة بالتعادل بعد الوقت الإضافي تُحسم بركلات الترجيح. في مخطط الأدوار الإقصائية يمكنك متابعة مسار كل منتخب دوراً بدور — بالتواريخ والمواجهات والنتائج — والضغط على أي مباراة لمعرفة النتيجة والهدّافين والتفاصيل.',
  };
  return intro[pickLang(locale)];
}
