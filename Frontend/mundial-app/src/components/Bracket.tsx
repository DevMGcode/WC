...
export const Bracket = ({ data }: BracketProps) => {
  ...
  return (
    <div className="w-full overflow-x-auto pb-8">
      <div className="inline-block min-w-max p-8 relative">
        <BracketConnectors
        ...
        <div className="flex gap-16 relative" style={{ zIndex: 2 }}>
          ...
          >
            ...
            <div className="flex flex-col justify-around" style={{ minHeight: '800px' }}>
          ...
          {/* Flecha */}
          <div className="flex items-center text-red-500 text-4xl font-bold">→</div>
          ...
          >
            ...
            <div className="flex flex-col justify-center items-center" style={{ minHeight: '800px' }}>
              <div
                ref={(el) => {
                  finalRef.current = el;
                }}
